...
class Question
{
    ...
    #[Assert\Length(min: 20, minMessage: "Veuillez detailler votre titre", max: 255, maxMessage: 'Le titre de votre question est trop long')]
    private ?string $title = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\NotBlank(message: "veuillez renseigner un Question")]
